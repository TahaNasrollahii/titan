  ...
  return (
    <>
      ...
      <main className={styles.main}>
        <GradientOrb color="magenta" size={600} top="-10%" right="-10%" opacity={0.15} />
        <GradientOrb color="blue" size={500} bottom="-10%" left="-10%" opacity={0.1} />
          ...
          <div className={styles.authContainer}>
            <div className={styles.authCard}>
              ...
              <div className={styles.header}>
                ...
                <h1 className={styles.title}>عضویت در تایتان</h1>
                <p className={styles.subtitle}>به هزاران گیمر خاورمیانه بپیوندید.</p>
              </div>
              ...
              <form className={styles.form}>
                ...
                <div className={styles.inputGroup}>
                  <div className={styles.inputIconWrapper}>
                    ...
                    <input type="text" placeholder="نام کاربری (انگلیسی)" className={styles.input} style={{ direction: 'ltr', textAlign: 'right' }} />
                  </div>
                </div>
                ...
                <div className={styles.inputGroup}>
                  <div className={styles.inputIconWrapper}>
                    ...
                    <input type="email" placeholder="ایمیل شما" className={styles.input} />
                  </div>
                </div>
